 ...
 *
 * Value should be arrayed of string representing paths to {@code .xls} files with DBUnit data or directories with {@code .csv} files, relative to maven class root(src/test/resources|src/test/java).
 *
