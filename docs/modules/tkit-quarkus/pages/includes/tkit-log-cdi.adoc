...
:summaryTableId: tkit-log-cdi
[.configuration-legend]
icon:lock[title=Fixed at build time] Configuration property fixed at build time - All other configuration properties are overridable at runtime
[.configuration-reference.searchable, cols="80,.^10,.^10"]
|===

h|[[tkit-log-cdi_configuration]]link:#tkit-log-cdi_configuration[Configuration property]

h|Type
h|Default

a| [[tkit-log-cdi_tkit-log-cdi-enabled]]`link:#tkit-log-cdi_tkit-log-cdi-enabled[tkit.log.cdi.enabled]`
...
a| [[tkit-log-cdi_tkit-log-cdi-custom-data-prefix]]`link:#tkit-log-cdi_tkit-log-cdi-custom-data-prefix[tkit.log.cdi.custom-data.prefix]`
...
a| [[tkit-log-cdi_tkit-log-cdi-start-enabled]]`link:#tkit-log-cdi_tkit-log-cdi-start-enabled[tkit.log.cdi.start.enabled]`
...
a| [[tkit-log-cdi_tkit-log-cdi-start-template]]`link:#tkit-log-cdi_tkit-log-cdi-start-template[tkit.log.cdi.start.template]`
...
a| [[tkit-log-cdi_tkit-log-cdi-succeed-enabled]]`link:#tkit-log-cdi_tkit-log-cdi-succeed-enabled[tkit.log.cdi.succeed.enabled]`
...
a| [[tkit-log-cdi_tkit-log-cdi-succeed-template]]`link:#tkit-log-cdi_tkit-log-cdi-succeed-template[tkit.log.cdi.succeed.template]`
...
a| [[tkit-log-cdi_tkit-log-cdi-failed-enabled]]`link:#tkit-log-cdi_tkit-log-cdi-failed-enabled[tkit.log.cdi.failed.enabled]`
...
a| [[tkit-log-cdi_tkit-log-cdi-failed-template]]`link:#tkit-log-cdi_tkit-log-cdi-failed-template[tkit.log.cdi.failed.template]`
...
a| [[tkit-log-cdi_tkit-log-cdi-return-void-template]]`link:#tkit-log-cdi_tkit-log-cdi-return-void-template[tkit.log.cdi.return-void-template]`
...
a| [[tkit-log-cdi_tkit-log-cdi-mdc-errorkey]]`link:#tkit-log-cdi_tkit-log-cdi-mdc-errorkey[tkit.log.cdi.mdc.errorKey]`
...
a| [[tkit-log-cdi_tkit-log-cdi-service-service-log]]`link:#tkit-log-cdi_tkit-log-cdi-service-service-log[tkit.log.cdi.service."service".log]`
...
a| [[tkit-log-cdi_tkit-log-cdi-service-service-stacktrace]]`link:#tkit-log-cdi_tkit-log-cdi-service-service-stacktrace[tkit.log.cdi.service."service".stacktrace]`
...
a| [[tkit-log-cdi_tkit-log-cdi-service-service-method-method-log]]`link:#tkit-log-cdi_tkit-log-cdi-service-service-method-method-log[tkit.log.cdi.service."service".method."method".log]`
...
a| [[tkit-log-cdi_tkit-log-cdi-service-service-method-method-stacktrace]]`link:#tkit-log-cdi_tkit-log-cdi-service-service-method-method-stacktrace[tkit.log.cdi.service."service".method."method".stacktrace]`
...
a| [[tkit-log-cdi_tkit-log-cdi-service-service-method-method-return-mask]]`link:#tkit-log-cdi_tkit-log-cdi-service-service-method-method-return-mask[tkit.log.cdi.service."service".method."method".return-mask]`
...
a| [[tkit-log-cdi_tkit-log-cdi-service-service-method-method-param]]`link:#tkit-log-cdi_tkit-log-cdi-service-service-method-method-param[tkit.log.cdi.service."service".method."method".param]`
