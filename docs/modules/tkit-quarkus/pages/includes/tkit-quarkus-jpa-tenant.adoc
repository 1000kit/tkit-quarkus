...
config_property_copy_button:+++tkit.jpa.tenant.default+++[]
...
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++tkit.jpa.tenant.root.enabled+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++tkit.jpa.tenant.root.value+++[]
endif::add-copy-button-to-config-props[]
