...
:summaryTableId: tkit-log-rs
[.configuration-legend]
icon:lock[title=Fixed at build time] Configuration property fixed at build time - All other configuration properties are overridable at runtime
[.configuration-reference.searchable, cols="80,.^10,.^10"]
|===

h|[[tkit-log-rs_configuration]]link:#tkit-log-rs_configuration[Configuration property]

h|Type
h|Default

a| [[tkit-log-rs_tkit-log-rs-enabled]]`link:#tkit-log-rs_tkit-log-rs-enabled[tkit.log.rs.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-principal-enabled]]`link:#tkit-log-rs_tkit-log-rs-principal-enabled[tkit.log.rs.principal.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-correlation-id-enabled]]`link:#tkit-log-rs_tkit-log-rs-correlation-id-enabled[tkit.log.rs.correlation-id-enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-correlation-id-header]]`link:#tkit-log-rs_tkit-log-rs-correlation-id-header[tkit.log.rs.correlation-id-header]`
...
a| [[tkit-log-rs_tkit-log-rs-start-enabled]]`link:#tkit-log-rs_tkit-log-rs-start-enabled[tkit.log.rs.start.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-start-template]]`link:#tkit-log-rs_tkit-log-rs-start-template[tkit.log.rs.start.template]`
...
a| [[tkit-log-rs_tkit-log-rs-end-enabled]]`link:#tkit-log-rs_tkit-log-rs-end-enabled[tkit.log.rs.end.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-end-template]]`link:#tkit-log-rs_tkit-log-rs-end-template[tkit.log.rs.end.template]`
...
a| [[tkit-log-rs_tkit-log-rs-end-mdc-enabled]]`link:#tkit-log-rs_tkit-log-rs-end-mdc-enabled[tkit.log.rs.end.mdc.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-end-mdc-duration-name]]`link:#tkit-log-rs_tkit-log-rs-end-mdc-duration-name[tkit.log.rs.end.mdc.duration.name]`
...
a| [[tkit-log-rs_tkit-log-rs-end-mdc-response-status-name]]`link:#tkit-log-rs_tkit-log-rs-end-mdc-response-status-name[tkit.log.rs.end.mdc.response-status.name]`
...
a| [[tkit-log-rs_tkit-log-rs-error-enabled]]`link:#tkit-log-rs_tkit-log-rs-error-enabled[tkit.log.rs.error.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-regex-enabled]]`link:#tkit-log-rs_tkit-log-rs-regex-enabled[tkit.log.rs.regex.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-regex-exclude]]`link:#tkit-log-rs_tkit-log-rs-regex-exclude[tkit.log.rs.regex.exclude]`
...
a| [[tkit-log-rs_tkit-log-rs-payload-enabled]]`link:#tkit-log-rs_tkit-log-rs-payload-enabled[tkit.log.rs.payload.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-payload-template]]`link:#tkit-log-rs_tkit-log-rs-payload-template[tkit.log.rs.payload.template]`
...
a| [[tkit-log-rs_tkit-log-rs-payload-empty-body-enabled]]`link:#tkit-log-rs_tkit-log-rs-payload-empty-body-enabled[tkit.log.rs.payload.empty-body-enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-payload-empty-body-message]]`link:#tkit-log-rs_tkit-log-rs-payload-empty-body-message[tkit.log.rs.payload.empty-body-message]`
...
a| [[tkit-log-rs_tkit-log-rs-payload-page-message]]`link:#tkit-log-rs_tkit-log-rs-payload-page-message[tkit.log.rs.payload.page-message]`
...
a| [[tkit-log-rs_tkit-log-rs-payload-max-entity-size]]`link:#tkit-log-rs_tkit-log-rs-payload-max-entity-size[tkit.log.rs.payload.max-entity-size]`
...
a| [[tkit-log-rs_tkit-log-rs-payload-regex-enabled]]`link:#tkit-log-rs_tkit-log-rs-payload-regex-enabled[tkit.log.rs.payload.regex.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-payload-regex-exclude]]`link:#tkit-log-rs_tkit-log-rs-payload-regex-exclude[tkit.log.rs.payload.regex.exclude]`
...
a| [[tkit-log-rs_tkit-log-rs-client-enabled]]`link:#tkit-log-rs_tkit-log-rs-client-enabled[tkit.log.rs.client.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-client-regex-enabled]]`link:#tkit-log-rs_tkit-log-rs-client-regex-enabled[tkit.log.rs.client.regex.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-client-regex-exclude]]`link:#tkit-log-rs_tkit-log-rs-client-regex-exclude[tkit.log.rs.client.regex.exclude]`
...
a| [[tkit-log-rs_tkit-log-rs-client-payload-enabled]]`link:#tkit-log-rs_tkit-log-rs-client-payload-enabled[tkit.log.rs.client.payload.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-client-payload-template]]`link:#tkit-log-rs_tkit-log-rs-client-payload-template[tkit.log.rs.client.payload.template]`
...
a| [[tkit-log-rs_tkit-log-rs-client-payload-empty-body-enabled]]`link:#tkit-log-rs_tkit-log-rs-client-payload-empty-body-enabled[tkit.log.rs.client.payload.empty-body-enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-client-payload-empty-body-message]]`link:#tkit-log-rs_tkit-log-rs-client-payload-empty-body-message[tkit.log.rs.client.payload.empty-body-message]`
...
a| [[tkit-log-rs_tkit-log-rs-client-payload-page-message]]`link:#tkit-log-rs_tkit-log-rs-client-payload-page-message[tkit.log.rs.client.payload.page-message]`
...
a| [[tkit-log-rs_tkit-log-rs-client-payload-max-entity-size]]`link:#tkit-log-rs_tkit-log-rs-client-payload-max-entity-size[tkit.log.rs.client.payload.max-entity-size]`
...
a| [[tkit-log-rs_tkit-log-rs-client-payload-regex-enabled]]`link:#tkit-log-rs_tkit-log-rs-client-payload-regex-enabled[tkit.log.rs.client.payload.regex.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-client-payload-regex-exclude]]`link:#tkit-log-rs_tkit-log-rs-client-payload-regex-exclude[tkit.log.rs.client.payload.regex.exclude]`
...
a| [[tkit-log-rs_tkit-log-rs-client-start-enabled]]`link:#tkit-log-rs_tkit-log-rs-client-start-enabled[tkit.log.rs.client.start.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-client-start-template]]`link:#tkit-log-rs_tkit-log-rs-client-start-template[tkit.log.rs.client.start.template]`
...
a| [[tkit-log-rs_tkit-log-rs-client-end-enabled]]`link:#tkit-log-rs_tkit-log-rs-client-end-enabled[tkit.log.rs.client.end.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-client-end-template]]`link:#tkit-log-rs_tkit-log-rs-client-end-template[tkit.log.rs.client.end.template]`
...
a| [[tkit-log-rs_tkit-log-rs-client-end-mdc-enabled]]`link:#tkit-log-rs_tkit-log-rs-client-end-mdc-enabled[tkit.log.rs.client.end.mdc.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-client-end-mdc-duration-name]]`link:#tkit-log-rs_tkit-log-rs-client-end-mdc-duration-name[tkit.log.rs.client.end.mdc.duration.name]`
...
a| [[tkit-log-rs_tkit-log-rs-client-end-mdc-response-status-name]]`link:#tkit-log-rs_tkit-log-rs-client-end-mdc-response-status-name[tkit.log.rs.client.end.mdc.response-status.name]`
...
a| [[tkit-log-rs_tkit-log-rs-client-error-enabled]]`link:#tkit-log-rs_tkit-log-rs-client-error-enabled[tkit.log.rs.client.error.enabled]`
...
a| [[tkit-log-rs_tkit-log-rs-mdc-headers-mdc-headers]]`link:#tkit-log-rs_tkit-log-rs-mdc-headers-mdc-headers[tkit.log.rs.mdc-headers]`
...
a| [[tkit-log-rs_tkit-log-rs-controller-controller-log]]`link:#tkit-log-rs_tkit-log-rs-controller-controller-log[tkit.log.rs.controller."controller".log]`
...
a| [[tkit-log-rs_tkit-log-rs-controller-controller-payload]]`link:#tkit-log-rs_tkit-log-rs-controller-controller-payload[tkit.log.rs.controller."controller".payload]`
...
a| [[tkit-log-rs_tkit-log-rs-controller-controller-mdc-headers]]`link:#tkit-log-rs_tkit-log-rs-controller-controller-mdc-headers[tkit.log.rs.controller."controller".mdc-headers]`
...
a| [[tkit-log-rs_tkit-log-rs-controller-controller-method-method-log]]`link:#tkit-log-rs_tkit-log-rs-controller-controller-method-method-log[tkit.log.rs.controller."controller".method."method".log]`
...
a| [[tkit-log-rs_tkit-log-rs-controller-controller-method-method-payload]]`link:#tkit-log-rs_tkit-log-rs-controller-controller-method-method-payload[tkit.log.rs.controller."controller".method."method".payload]`
...
a| [[tkit-log-rs_tkit-log-rs-controller-controller-method-method-mdc-headers]]`link:#tkit-log-rs_tkit-log-rs-controller-controller-method-method-mdc-headers[tkit.log.rs.controller."controller".method."method".mdc-headers]`
...
a| [[tkit-log-rs_tkit-log-rs-client-mdc-headers-mdc-headers]]`link:#tkit-log-rs_tkit-log-rs-client-mdc-headers-mdc-headers[tkit.log.rs.client.mdc-headers]`
